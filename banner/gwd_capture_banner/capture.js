...
function module$contents$google3$third_party$javascript$safevalues$builders$attribute_builders_safeAttrPrefix(templ) {
  return new module$exports$google3$third_party$javascript$safevalues$internals$attribute_impl$SafeAttributePrefix(templ[0].toLowerCase());
}
...
function goog$html$TrustedResourceUrl$createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(url) {
  if (void 0 === goog$html$trustedtypes$cachedPolicy_) {
    var JSCompiler_inline_result = null;
    var policyFactory = goog$global.trustedTypes;
    if (policyFactory && policyFactory.createPolicy) {
      try {
        JSCompiler_inline_result = policyFactory.createPolicy("goog#html", {createHTML:goog$identity_, createScript:goog$identity_, createScriptURL:goog$identity_});
      } catch (e) {
        goog$global.console && goog$global.console.error(e.message);
      }
      goog$html$trustedtypes$cachedPolicy_ = JSCompiler_inline_result;
    } else {
      goog$html$trustedtypes$cachedPolicy_ = JSCompiler_inline_result;
    }
  }
  url = (JSCompiler_inline_result = goog$html$trustedtypes$cachedPolicy_) ? JSCompiler_inline_result.createScriptURL(url) : url;
  return new goog$html$TrustedResourceUrl(url);
}
;function module$contents$google3$third_party$javascript$safevalues$builders$resource_url_builders_trustedResourceUrl(templateObj, ...rest) {
  if (0 === rest.length) {
    return goog$html$TrustedResourceUrl$createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(templateObj[0]);
  }
...
module$contents$google3$third_party$javascript$safevalues$builders$resource_url_builders_trustedResourceUrl`js/static/codemirror.html`;
module$contents$google3$third_party$javascript$safevalues$builders$resource_url_builders_trustedResourceUrl`js/static/componentpreview.html`;
...
var module$exports$ninja$constants$checkCefMajorVersion = () => {
  const ninjaShell = goog$global.ninjaShell;
  return ninjaShell ? 120 <= (null == ninjaShell ? void 0 : ninjaShell.cefMajorVersion) : !0;
};
...
function module$contents$google3$third_party$javascript$safevalues$dom$elements$element_setPrefixedAttribute(attrPrefixes, e, attr, value) {
  ...
  attrPrefixes = attrPrefixes.map(s => {
    if (s instanceof module$exports$google3$third_party$javascript$safevalues$internals$attribute_impl$SafeAttributePrefix) {
      s = s.privateDoNotAccessOrElseWrappedAttributePrefix;
    } else {
      throw Error("");
    }
    return s;
...
function goog$events$Event(type, opt_target) {
  this.type = type;
  this.JSC$2407_currentTarget = this.target = opt_target;
  this.defaultPrevented = !1;
}
goog$events$Event.prototype.JSC$2409_preventDefault = function() {
...
function JSCompiler_StaticMethods_JSC$2417_seek(JSCompiler_StaticMethods_JSC$2417_seek$self, timeMs) {
  if (JSCompiler_StaticMethods_JSC$2417_seek$self.seekPromise_) {
    return Promise.reject();
  }
  const oldTimeMs = JSCompiler_StaticMethods_JSC$2417_seek$self.video_.currentTime / 1E3, updateTime = new Promise(resolve => {
    const needsToLoad = "notLoaded" === JSCompiler_StaticMethods_JSC$2417_seek$self.loadState_;
    needsToLoad && JSCompiler_StaticMethods_load_(JSCompiler_StaticMethods_JSC$2417_seek$self);
    (JSCompiler_StaticMethods_JSC$2417_seek$self.loadPromise_ || Promise.resolve()).then(() => {
      "loaded" === JSCompiler_StaticMethods_JSC$2417_seek$self.loadState_ ? (timeMs = goog$math$clamp(timeMs, 0, 1E3 * JSCompiler_StaticMethods_JSC$2417_seek$self.video_.duration), !needsToLoad && .1 >= Math.abs(1E3 * JSCompiler_StaticMethods_JSC$2417_seek$self.video_.currentTime - timeMs) ? resolve(!0) : (JSCompiler_StaticMethods_JSC$2417_seek$self.video_.requestVideoFrameCallback(() => {
        resolve(!0);
      }), JSCompiler_StaticMethods_JSC$2417_seek$self.video_.currentTime = (needsToLoad && .1 > timeMs ? .1 : timeMs) / 1E3)) : resolve(!1);
    });
  });
  JSCompiler_StaticMethods_JSC$2417_seek$self.seekPromise_ = Promise.race([updateTime, new Promise((resolve, reject) => {
    setTimeout(() => {
      reject(new module$exports$ninja$capture$AppError$AppError(3, `Timed out seeking ${JSCompiler_StaticMethods_JSC$2417_seek$self.video_.getAttribute("src")} from ` + `${oldTimeMs} to ${timeMs}`));
    }, 1E4);
  })]).then(success => {
    success && JSCompiler_StaticMethods_JSC$2417_seek$self.canvas_.getContext("2d").drawImage(JSCompiler_StaticMethods_JSC$2417_seek$self.video_, 0, 0, JSCompiler_StaticMethods_JSC$2417_seek$self.canvas_.width, JSCompiler_StaticMethods_JSC$2417_seek$self.canvas_.height);
    JSCompiler_StaticMethods_JSC$2417_seek$self.seekPromise_ = null;
  });
  return JSCompiler_StaticMethods_JSC$2417_seek$self.seekPromise_;
}
...
function JSCompiler_StaticMethods_curveParameterAtValue(JSCompiler_StaticMethods_curveParameterAtValue$self, val) {
  ...
  for (var i = 0; 8 > i; i++) {
    ...
    var JSCompiler_StaticMethods_JSC$2431_derivative$self = JSCompiler_StaticMethods_curveParameterAtValue$self, u$jscomp$0 = u;
    u$jscomp$0 = goog$math$clamp(u$jscomp$0, 0, 1);
    var q0 = 3 * (JSCompiler_StaticMethods_JSC$2431_derivative$self.ctrlPts[1] - JSCompiler_StaticMethods_JSC$2431_derivative$self.ctrlPts[0]), q1 = 3 * (JSCompiler_StaticMethods_JSC$2431_derivative$self.ctrlPts[2] - JSCompiler_StaticMethods_JSC$2431_derivative$self.ctrlPts[1]);
    JSCompiler_StaticMethods_JSC$2431_derivative$self = 3 * (JSCompiler_StaticMethods_JSC$2431_derivative$self.ctrlPts[3] - JSCompiler_StaticMethods_JSC$2431_derivative$self.ctrlPts[2]);
    q0 = goog$math$lerp(q0, q1, u$jscomp$0);
    q1 = goog$math$lerp(q1, JSCompiler_StaticMethods_JSC$2431_derivative$self, u$jscomp$0);
...
var vec$jscomp$inline_272 = [0, 1 / 3, 2 / 3, 1];
const newVec$jscomp$inline_273 = new Float64Array(4);
newVec$jscomp$inline_273[0] = vec$jscomp$inline_272[0];
newVec$jscomp$inline_273[1] = vec$jscomp$inline_272[1];
newVec$jscomp$inline_273[2] = vec$jscomp$inline_272[2];
newVec$jscomp$inline_273[3] = vec$jscomp$inline_272[3];
const module$contents$ninja$math$BezierSegment_DEFAULT_CONTROL_POINTS = newVec$jscomp$inline_273;
...
class module$exports$ninja$math$BezierSegment2d {
  constructor(controlPoints) {
    this.JSC$2445_xBezier_ = new module$exports$ninja$math$BezierSegment();
    this.JSC$2445_yBezier_ = new module$exports$ninja$math$BezierSegment();
    if (controlPoints) {
      var vec = this.JSC$2445_xBezier_.ctrlPts, v1 = controlPoints.c1[0], v2 = controlPoints.c2[0], v3 = controlPoints.c3[0];
      vec[0] = controlPoints.c0[0];
      vec[1] = v1;
      vec[2] = v2;
      vec[3] = v3;
      vec = this.JSC$2445_yBezier_.ctrlPts;
  ...
  value(u, result = goog$vec$vec2d$create()) {
    return goog$vec$vec2d$setFromValues(result, this.JSC$2445_xBezier_.value(u), this.JSC$2445_yBezier_.value(u));
  }
}
...
var module$exports$ninja$model$css$cssConstants$MASK_IMAGE_PROPERTY = module$exports$ninja$constants$checkCefMajorVersion() ? "mask-image" : "-webkit-mask-image";
...
module$exports$ninja$anim$animConstants$ANIMATABLE_MASK_PROPERTIES = module$exports$ninja$constants$checkCefMajorVersion() ? new Set(["clip-path", "mask-image", "mask-position", "mask-size"]) : new Set(["clip-path", "-webkit-mask-image", "-webkit-mask-position", "-webkit-mask-size"]), module$exports$ninja$anim$animConstants$ANIMATABLE_CANVAS_PROPERTIES = new Set("bottom height left margin margin-bottom margin-left margin-right margin-top opacity padding padding-bottom padding-left padding-right padding-top right top transform transform-origin transform-origin-x transform-origin-y transform-origin-z width".split(" ")), 
module$exports$ninja$anim$animConstants$ANIMATABLE_AMP_PROPERTIES = new Set(["opacity", "transform", "visibility"]), module$exports$ninja$anim$animConstants$COMPUTABLE_ANIMATION_PROPERTIES = module$exports$ninja$constants$checkCefMajorVersion() ? new Set("--gwd-hidden-css-filter mask-image mask-position mask-size left right top bottom width height opacity transform border-bottom-left-radius border-bottom-right-radius border-top-left-radius border-top-right-radius margin-bottom margin-left margin-right margin-top padding-bottom padding-left padding-right padding-top visibility".split(" ")) : 
new Set("--gwd-hidden-css-filter -webkit-mask-image -webkit-mask-position -webkit-mask-size left right top bottom width height opacity transform border-bottom-left-radius border-bottom-right-radius border-top-left-radius border-top-right-radius margin-bottom margin-left margin-right margin-top padding-bottom padding-left padding-right padding-top visibility".split(" "));
var JSCompiler_inline_result$jscomp$26, obj$jscomp$inline_319;
a: {
  for (var parts$jscomp$inline_980 = ["CLOSURE_FLAGS"], cur$jscomp$inline_981 = goog$global, i$jscomp$inline_982 = 0; i$jscomp$inline_982 < parts$jscomp$inline_980.length; i$jscomp$inline_982++) {
    if (cur$jscomp$inline_981 = cur$jscomp$inline_981[parts$jscomp$inline_980[i$jscomp$inline_982]], null == cur$jscomp$inline_981) {
      obj$jscomp$inline_319 = null;
      break a;
    }
  }
  obj$jscomp$inline_319 = cur$jscomp$inline_981;
}
var val$jscomp$inline_320 = obj$jscomp$inline_319 && obj$jscomp$inline_319[610401301];
JSCompiler_inline_result$jscomp$26 = null != val$jscomp$inline_320 ? val$jscomp$inline_320 : !1;
...
var JSCompiler_inline_result$jscomp$27;
const navigator$jscomp$inline_322 = goog$global.navigator;
JSCompiler_inline_result$jscomp$27 = navigator$jscomp$inline_322 ? navigator$jscomp$inline_322.userAgentData || null : null;
function module$contents$goog$labs$userAgent$util_matchUserAgentDataBrand(str) {
  return JSCompiler_inline_result$jscomp$26 ? JSCompiler_inline_result$jscomp$27 ? JSCompiler_inline_result$jscomp$27.brands.some(({brand}) => brand && -1 != brand.indexOf(str)) : !1 : !1;
}
...
;function module$contents$goog$labs$userAgent$browser_useUserAgentDataBrand() {
  return JSCompiler_inline_result$jscomp$26 ? !!JSCompiler_inline_result$jscomp$27 && 0 < JSCompiler_inline_result$jscomp$27.brands.length : !1;
}
...
;function module$contents$goog$labs$userAgent$platform_useUserAgentDataPlatform() {
  return JSCompiler_inline_result$jscomp$26 ? !!JSCompiler_inline_result$jscomp$27 && !!JSCompiler_inline_result$jscomp$27.platform : !1;
}
function module$contents$goog$labs$userAgent$platform_isAndroid() {
  return module$contents$goog$labs$userAgent$platform_useUserAgentDataPlatform() ? "Android" === JSCompiler_inline_result$jscomp$27.platform : module$contents$goog$labs$userAgent$util_matchUserAgent("Android");
}
...
function module$contents$goog$labs$userAgent$platform_isMacintosh() {
  return module$contents$goog$labs$userAgent$platform_useUserAgentDataPlatform() ? "macOS" === JSCompiler_inline_result$jscomp$27.platform : module$contents$goog$labs$userAgent$util_matchUserAgent("Macintosh");
}
function module$contents$goog$labs$userAgent$platform_isWindows() {
  return module$contents$goog$labs$userAgent$platform_useUserAgentDataPlatform() ? "Windows" === JSCompiler_inline_result$jscomp$27.platform : module$contents$goog$labs$userAgent$util_matchUserAgent("Windows");
}
function module$contents$goog$labs$userAgent$platform_isChromeOS() {
  return module$contents$goog$labs$userAgent$platform_useUserAgentDataPlatform() ? "Chrome OS" === JSCompiler_inline_result$jscomp$27.platform : module$contents$goog$labs$userAgent$util_matchUserAgent("CrOS");
}
...
!module$contents$goog$labs$userAgent$util_matchUserAgent("Edge"), JSCompiler_inline_result$jscomp$28;
a: {
  var version$jscomp$inline_324 = "", arr$jscomp$inline_325 = function() {
  ...
  arr$jscomp$inline_325 && (version$jscomp$inline_324 = arr$jscomp$inline_325 ? arr$jscomp$inline_325[1] : "");
  if (goog$userAgent$IE) {
    var docMode$jscomp$inline_326, doc$jscomp$inline_986 = goog$global.document;
    docMode$jscomp$inline_326 = doc$jscomp$inline_986 ? doc$jscomp$inline_986.documentMode : void 0;
    if (null != docMode$jscomp$inline_326 && docMode$jscomp$inline_326 > parseFloat(version$jscomp$inline_324)) {
      JSCompiler_inline_result$jscomp$28 = String(docMode$jscomp$inline_326);
      break a;
    }
  }
  JSCompiler_inline_result$jscomp$28 = version$jscomp$inline_324;
}
var goog$userAgent$VERSION = JSCompiler_inline_result$jscomp$28;
...
function JSCompiler_StaticMethods_maybeUpdateNonCanonicalTransformStateToEdited_(JSCompiler_StaticMethods_maybeUpdateNonCanonicalTransformStateToEdited_$self) {
  "not_canonical_not_edited" === JSCompiler_StaticMethods_maybeUpdateNonCanonicalTransformStateToEdited_$self.JSC$2483_state_ && (JSCompiler_StaticMethods_maybeUpdateNonCanonicalTransformStateToEdited_$self.JSC$2483_state_ = "not_canonical_edited");
}
...
class module$contents$ninja$model$threeD$GwdTransform_GwdTransform {
  ...
  getCss(requiredFunctions = []) {
    return "not_canonical_not_edited" === this.JSC$2483_state_ ? this.initTransformValue_ : JSCompiler_StaticMethods_getChannelsCss_(this, requiredFunctions, null);
  }
  hasTranslation() {
  ...
  isIdentity() {
    if ("not_canonical_not_edited" === this.JSC$2483_state_) {
  ...
  getMatrix(element) {
    element = "not_canonical_not_edited" === this.JSC$2483_state_ ? this.initTransformValue_ : JSCompiler_StaticMethods_getChannelsCss_(this, [], element || null);
...
;var module$exports$ninja$capture$VideoClipController$VideoClipController = class {
  constructor(element, properties, frameSequence) {
    this.JSC$2503_element_ = element;
    this.JSC$2503_frameSequence_ = frameSequence;
    ...
    this.backingVideo_ = new module$exports$ninja$capture$BackingVideo$BackingVideo(this.JSC$2503_element_);
    this.lastSequenceIndexInClip_ = this.firstSequenceIndexInClip_ = this.currentSequenceIndex_ = -1;
    this.isActive_ = !0;
    element = this.JSC$2503_frameSequence_.frameRate();
    properties = this.JSC$2503_frameSequence_;
    ...
    $jscomp$optchain$tmp858453898$0 = this.JSC$2503_frameSequence_.indices_.startFrame;
    const frameIncrement = this.JSC$2503_frameSequence_.indices_.increment;
    ...
    this.lastSequenceIndexInClip_ = Math.min(this.JSC$2503_frameSequence_.length() - 1, Math.floor((frameSequence - $jscomp$optchain$tmp858453898$0) / frameIncrement));
    element = JSCompiler_StaticMethods_sequenceIndexToTimeMs(this.JSC$2503_frameSequence_, this.lastSequenceIndexInClip_);
...
function JSCompiler_StaticMethods_JSC$2511_getKeyAtTime(JSCompiler_StaticMethods_JSC$2511_getKeyAtTime$self, time) {
  time = JSCompiler_StaticMethods_getIndexAtTime_(JSCompiler_StaticMethods_JSC$2511_getKeyAtTime$self, time);
  return JSCompiler_StaticMethods_JSC$2511_getKeyAtTime$self.animKeys_[time] || null;
}
...
function JSCompiler_StaticMethods_clearTracks_(JSCompiler_StaticMethods_clearTracks_$self) {
  JSCompiler_StaticMethods_clearTracks_$self.JSC$2527_tracks_.clear();
...
function JSCompiler_StaticMethods_insertAnimKey(JSCompiler_StaticMethods_insertAnimKey$self, property, time, value, easing, {autoInsertFirstKey} = {autoInsertFirstKey:!0}, {isVisibilityKey} = {isVisibilityKey:!1}) {
  ...
  let track = JSCompiler_StaticMethods_insertAnimKey$self.JSC$2527_tracks_.get(property);
  track || (track = new module$exports$ninja$anim$AnimTrack(), JSCompiler_StaticMethods_insertAnimKey$self.JSC$2527_tracks_.set(property, track));
  ...
  JSCompiler_StaticMethods_JSC$2511_getKeyAtTime(track, time) || JSCompiler_StaticMethods_addUniqueKey_(JSCompiler_StaticMethods_insertAnimKey$self, time);
...
function JSCompiler_StaticMethods_updateWebAnimationsInput(JSCompiler_StaticMethods_updateWebAnimationsInput$self) {
  ...
  JSCompiler_StaticMethods_updateWebAnimationsInput$self.webAnimationsInput_ = {keyframes:times.map(time => {
    ...
    var JSCompiler_inline_result = null;
    var JSCompiler_object_inline_isMixed_1376 = !1;
    for (const property of JSCompiler_StaticMethods_updateWebAnimationsInput$self.JSC$2527_tracks_.keys()) {
      var key = JSCompiler_StaticMethods_JSC$2511_getKeyAtTime(JSCompiler_StaticMethods_updateWebAnimationsInput$self.JSC$2527_tracks_.get(property), time);
      if (key && key.easing) {
        ...
        if (!JSCompiler_inline_result$jscomp$0) {
          ...
          JSCompiler_object_inline_isMixed_1376 = !0;
          break;
        }
      }
    }
    JSCompiler_inline_result = !JSCompiler_inline_result || JSCompiler_object_inline_isMixed_1376 ? new module$exports$ninja$anim$CssEasing$CssEasing("linear") : JSCompiler_inline_result;
    ...
    for (const property of animatableProperties) {
      JSCompiler_inline_result = goog$string$toCamelCase(property.replace("-webkit-", "")), (JSCompiler_object_inline_isMixed_1376 = JSCompiler_StaticMethods_JSC$2511_getKeyAtTime(JSCompiler_StaticMethods_updateWebAnimationsInput$self.JSC$2527_tracks_.get(property), time)) ? JSCompiler_object_inline_isMixed_1376.value && "initial" !== JSCompiler_object_inline_isMixed_1376.value && (keyframe[JSCompiler_inline_result] = JSCompiler_object_inline_isMixed_1376.value) : JSCompiler_object_inline_isMixed_1376 || 
      1 !== keyframe.offset && 0 !== keyframe.offset || (JSCompiler_object_inline_isMixed_1376 = JSCompiler_StaticMethods_updateWebAnimationsInput$self.JSC$2527_tracks_.get(property), (JSCompiler_object_inline_isMixed_1376 = 0 === keyframe.offset ? JSCompiler_StaticMethods_getFirstKey(JSCompiler_object_inline_isMixed_1376) : JSCompiler_StaticMethods_getLastKey(JSCompiler_object_inline_isMixed_1376)) && JSCompiler_object_inline_isMixed_1376.value && "initial" !== JSCompiler_object_inline_isMixed_1376.value && 
      (keyframe[JSCompiler_inline_result] = JSCompiler_object_inline_isMixed_1376.value));
    }
    return keyframe;
...
function JSCompiler_StaticMethods_getKeyframeTimes(JSCompiler_StaticMethods_getKeyframeTimes$self, property) {
  return (JSCompiler_StaticMethods_getKeyframeTimes$self = JSCompiler_StaticMethods_getKeyframeTimes$self.JSC$2527_tracks_.get(property)) ? JSCompiler_StaticMethods_getKeyTimes(JSCompiler_StaticMethods_getKeyframeTimes$self) : [];
}
...
function JSCompiler_StaticMethods_getKeyedProperties(JSCompiler_StaticMethods_getKeyedProperties$self) {
  return new Set([...JSCompiler_StaticMethods_getKeyedProperties$self.JSC$2527_tracks_.keys()]);
}
function JSCompiler_StaticMethods_JSC$2544_getKeyAtTime(JSCompiler_StaticMethods_JSC$2544_getKeyAtTime$self, property, time) {
  return (JSCompiler_StaticMethods_JSC$2544_getKeyAtTime$self = JSCompiler_StaticMethods_JSC$2544_getKeyAtTime$self.JSC$2527_tracks_.get(property)) ? JSCompiler_StaticMethods_JSC$2511_getKeyAtTime(JSCompiler_StaticMethods_JSC$2544_getKeyAtTime$self, time) : null;
}
function JSCompiler_StaticMethods_canHaveAnimKey_(JSCompiler_StaticMethods_canHaveAnimKey_$self, property, value, {isVisibilityKey}) {
  ...
  if (!isVisibilityKey && property === module$exports$ninja$model$css$cssConstants$MASK_IMAGE_PROPERTY || ("fill" === property || "stroke" === property) && value.includes("gradient")) {
    return !1;
  }
...
function JSCompiler_StaticMethods_deleteAnimKey(JSCompiler_StaticMethods_deleteAnimKey$self, property, time) {
  if (!JSCompiler_StaticMethods_warnIfReadOnly_(JSCompiler_StaticMethods_deleteAnimKey$self)) {
    time = module$exports$ninja$math$mathUtils$cleanseFloatingPoint(.1 * Math.round(time / .1));
    var track = JSCompiler_StaticMethods_deleteAnimKey$self.JSC$2527_tracks_.get(property);
    if (track) {
      ...
      0 === JSCompiler_StaticMethods_getKeyTimes(track).length && JSCompiler_StaticMethods_deleteAnimKey$self.JSC$2527_tracks_.delete(property);
...
function JSCompiler_StaticMethods_editAnimKeyEasing(JSCompiler_StaticMethods_editAnimKeyEasing$self, time, easing) {
  if (!JSCompiler_StaticMethods_warnIfReadOnly_(JSCompiler_StaticMethods_editAnimKeyEasing$self) && (JSCompiler_StaticMethods_editAnimKeyEasing$self = JSCompiler_StaticMethods_editAnimKeyEasing$self.JSC$2527_tracks_.get("visibility"))) {
...
function JSCompiler_StaticMethods_getUniqueTimesExcludingMotionPathKeys_(JSCompiler_StaticMethods_getUniqueTimesExcludingMotionPathKeys_$self) {
  const motionPathTrack = JSCompiler_StaticMethods_getUniqueTimesExcludingMotionPathKeys_$self.JSC$2527_tracks_.get("motion-path"), times = JSCompiler_StaticMethods_getUniqueKeyTimes(JSCompiler_StaticMethods_getUniqueTimesExcludingMotionPathKeys_$self);
  return motionPathTrack ? times.filter(time => !JSCompiler_StaticMethods_JSC$2511_getKeyAtTime(motionPathTrack, time) || 1 < JSCompiler_StaticMethods_getUniqueTimesExcludingMotionPathKeys_$self.keyCounter_.get(time)) : times;
}
function JSCompiler_StaticMethods_copyValuesToLastKeyframe(JSCompiler_StaticMethods_copyValuesToLastKeyframe$self) {
  ...
  for (const property of JSCompiler_StaticMethods_copyValuesToLastKeyframe$self.JSC$2527_tracks_.keys()) {
    if ("motion-path" === property || module$contents$ninja$anim$animTracks_isInvalidOrDisabled(property) || JSCompiler_StaticMethods_JSC$2544_getKeyAtTime(JSCompiler_StaticMethods_copyValuesToLastKeyframe$self, property, uniqueTimes)) {
      continue;
    }
    const key = JSCompiler_StaticMethods_getLastKey(JSCompiler_StaticMethods_copyValuesToLastKeyframe$self.JSC$2527_tracks_.get(property));
...
function JSCompiler_StaticMethods_addVisibilityKeys(JSCompiler_StaticMethods_addVisibilityKeys$self) {
  ({includeInitialStyles} = {includeInitialStyles:!0});
  var includeInitialStyles;
  ...
  if (isFinite(Object.assign({}, rangeModel.range_).end)) {
    ...
    const lastVisibilityKey = null == ($jscomp$optchain$tmpm461956423$0 = JSCompiler_StaticMethods_addVisibilityKeys$self.JSC$2527_tracks_.get("visibility")) ? void 0 : JSCompiler_StaticMethods_getLastKey($jscomp$optchain$tmpm461956423$0);
...
function JSCompiler_StaticMethods_removeVisibilityKeys(JSCompiler_StaticMethods_removeVisibilityKeys$self) {
  if (JSCompiler_StaticMethods_removeVisibilityKeys$self.visibilityKeysSnapshot_) {
    ...
    lastKeyEasing && (shifts = JSCompiler_StaticMethods_getLastKey(JSCompiler_StaticMethods_removeVisibilityKeys$self.JSC$2527_tracks_.get("visibility")), JSCompiler_StaticMethods_editAnimKeyEasing(JSCompiler_StaticMethods_removeVisibilityKeys$self, shifts.time, lastKeyEasing));
    ...
    for (const time of emptyKeyTimes) {
      initialVisibilityStylesAdded = JSCompiler_StaticMethods_removeVisibilityKeys$self, emptyKeyTimes = time, {autoInsertFirstKey:lastKeyEasing} = {autoInsertFirstKey:!1}, JSCompiler_StaticMethods_warnIfReadOnly_(initialVisibilityStylesAdded) || (emptyKeyTimes = module$exports$ninja$math$mathUtils$cleanseFloatingPoint(.1 * Math.round(emptyKeyTimes / .1)), initialVisibilityStylesAdded.keyCounter_.has(emptyKeyTimes) || (JSCompiler_StaticMethods_expandToIncludeTime(initialVisibilityStylesAdded.visibilityRange_, 
      emptyKeyTimes), initialVisibilityStylesAdded.keyCounter_.set(emptyKeyTimes, 0), emptyKeyTimes = JSCompiler_StaticMethods_getStartTimeMs(initialVisibilityStylesAdded.visibilityRange_), lastKeyEasing && !initialVisibilityStylesAdded.keyCounter_.has(emptyKeyTimes) && initialVisibilityStylesAdded.keyCounter_.set(emptyKeyTimes, 0)));
    }
  }
}
function JSCompiler_StaticMethods_getWebAnimationsProperties(JSCompiler_StaticMethods_getWebAnimationsProperties$self) {
  return new Set([...JSCompiler_StaticMethods_getWebAnimationsProperties$self.JSC$2527_tracks_.keys()].filter(property => "motion-path" !== property && !module$contents$ninja$anim$animTracks_isInvalidOrDisabled(property)));
}
...
const module$contents$ninja$anim$AnimationEvaluator_CSS_NON_NUMERIC_VALUES = new Set(["auto", "initial", "inherit", "unset"]), module$contents$ninja$anim$AnimationEvaluator_MASK_SIZE_AND_POSITION_PROPERTIES = module$exports$ninja$constants$checkCefMajorVersion() ? new Set(["mask-position", "mask-size"]) : new Set(["-webkit-mask-position", "-webkit-mask-size"]), module$contents$ninja$anim$AnimationEvaluator_DISCRETE_ANIMATION_PROPERTIES = new Set([module$exports$ninja$model$css$cssConstants$MASK_IMAGE_PROPERTY, 
"--gwd-hidden-css-filter"]);
...
function JSCompiler_StaticMethods_computeIntermediateAnimatedValue_(JSCompiler_StaticMethods_computeIntermediateAnimatedValue_$self, startTime, endTime, time, property) {
  var leftKey = JSCompiler_StaticMethods_JSC$2544_getKeyAtTime(JSCompiler_StaticMethods_computeIntermediateAnimatedValue_$self.JSC$2546_tracks_, property, startTime), rightKey = JSCompiler_StaticMethods_JSC$2544_getKeyAtTime(JSCompiler_StaticMethods_computeIntermediateAnimatedValue_$self.JSC$2546_tracks_, property, endTime);
  if (!leftKey || !rightKey) {
    return null;
  }
  ...
  "step-start" == leftKey.easingType_ ? startTime = 0 <= startTime ? 1 : 0 : "step-end" == leftKey.easingType_ ? startTime = 1 <= startTime ? 1 : 0 : (endTime = leftKey.bezier_, startTime = endTime.JSC$2445_yBezier_.value(JSCompiler_StaticMethods_curveParameterAtValue(endTime.JSC$2445_xBezier_, startTime)));
  ...
  if ("transform" === property) {
    return startValue = new module$contents$ninja$model$threeD$GwdTransform_GwdTransform(startValue), rightKey = new module$contents$ninja$model$threeD$GwdTransform_GwdTransform(rightKey), "canonical" !== startValue.JSC$2483_state_ || "canonical" !== rightKey.JSC$2483_state_ ? startTime = null : ($jscomp$nullish$tmp8 = startValue, leftKey = rightKey, {isDelta:rightKey} = {isDelta:!0}, JSCompiler_StaticMethods_computeIntermediateAnimatedValue_$self = JSCompiler_StaticMethods_getInterpolatedChannelDiff2D_($jscomp$nullish$tmp8.getPercentTranslation(), 
    leftKey.getPercentTranslation(), startTime, {isDelta:rightKey}), property = JSCompiler_StaticMethods_getInterpolatedChannelDiff_($jscomp$nullish$tmp8.getTranslation(), leftKey.getTranslation(), startTime, {isDelta:rightKey}), endTime = JSCompiler_StaticMethods_getInterpolatedChannelDiff_($jscomp$nullish$tmp8.getRotation(), leftKey.getRotation(), startTime, {isDelta:rightKey}), time = JSCompiler_StaticMethods_getInterpolatedChannelDiff_($jscomp$nullish$tmp8.getScale(), leftKey.getScale(), startTime, 
    {isDelta:rightKey}), $jscomp$nullish$tmp8 = module$contents$goog$object_unsafeClone($jscomp$nullish$tmp8.channels_.motionPath), leftKey = module$contents$goog$object_unsafeClone(leftKey.channels_.motionPath), startTime = {transformOriginDelta:JSCompiler_StaticMethods_getInterpolatedChannelDiff2D_($jscomp$nullish$tmp8.transformOriginDelta, leftKey.transformOriginDelta, startTime, {isDelta:rightKey}), translation:JSCompiler_StaticMethods_getInterpolatedChannelDiff2D_($jscomp$nullish$tmp8.translation, 
    leftKey.translation, startTime, {isDelta:rightKey}), rotationZ:JSCompiler_StaticMethods_getInterpolatedMeasurementDiff_($jscomp$nullish$tmp8.rotationZ, leftKey.rotationZ, startTime, {isDelta:rightKey})}, startTime = {isDelta:rightKey, percentTranslation:JSCompiler_StaticMethods_computeIntermediateAnimatedValue_$self, translation:property, rotation:endTime, scale:time, motionPath:startTime}, startValue = startValue.clone(), JSCompiler_StaticMethods_applyChannelDiffs(startValue, startTime), startTime = 
    startValue), startTime && startTime.getCss();
  }
  ...
  rightKey = JSCompiler_StaticMethods_matchUnits_(property, rightKey, startValue, JSCompiler_StaticMethods_computeIntermediateAnimatedValue_$self.JSC$2546_element_);
...
function JSCompiler_StaticMethods_getAnimatedValuesAtTime_(JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self, time) {
  const properties = {};
  if (!JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.JSC$2546_element_.parentElement) {
    return properties;
  }
  JSCompiler_StaticMethods_addVisibilityKeys(JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.JSC$2546_tracks_);
  const {iterations, fill, direction} = JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.adapter_.timingDictionary_, {delay, duration} = JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.JSC$2546_tracks_.webAnimationsInput_;
  ...
  duration$jscomp$0 = JSCompiler_StaticMethods_getWebAnimationsProperties(JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.JSC$2546_tracks_);
  for (var property$jscomp$0 of duration$jscomp$0) {
    duration$jscomp$0 = JSCompiler_inline_result;
    iterations$jscomp$0 = JSCompiler_StaticMethods_getKeyframeTimes(JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.JSC$2546_tracks_, property$jscomp$0);
    ...
    var $jscomp$inline_1029 = void 0;
    if ((iterations$jscomp$0 = null == ($jscomp$inline_1029 = JSCompiler_StaticMethods_JSC$2544_getKeyAtTime(JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.JSC$2546_tracks_, property$jscomp$0, duration$jscomp$0)) ? void 0 : $jscomp$inline_1029.value) && "initial" !== iterations$jscomp$0) {
      ...
      if (module$exports$ninja$anim$animConstants$COMPUTABLE_ANIMATION_PROPERTIES.has(property$jscomp$0)) {
        const {left:startTime, right:endTime} = JSCompiler_StaticMethods_getBoundingKeyframeTimes(JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.JSC$2546_tracks_, duration$jscomp$0, property$jscomp$0);
  ...
  if (unevaluatedProperties.length) {
    JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.dummyElement_ || (JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.dummyElement_ = JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.JSC$2546_element_.ownerDocument.createElement(JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.JSC$2546_element_.tagName), JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.dummyElement_.style.visibility = "hidden", JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.dummyElement_.style.position = 
    "absolute", property$jscomp$0 = window.getComputedStyle(JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.JSC$2546_element_), JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.dummyElement_.style.setProperty("border", property$jscomp$0.getPropertyValue("border")), JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.JSC$2546_element_.parentElement.appendChild(JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.dummyElement_));
    JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.dummyPlayer_ || (JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.dummyPlayer_ = JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.dummyElement_.animate(JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.JSC$2546_tracks_.webAnimationsInput_.keyframes, timingInput), JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self.dummyPlayer_.pause());
    ...
    for (const property of unevaluatedProperties) {
      if ("motion-path" !== property && (property$jscomp$0 = timingInput[property], !module$contents$ninja$anim$AnimationEvaluator_CSS_NON_NUMERIC_VALUES.has(property$jscomp$0))) {
        if ("transform" === property) {
          unevaluatedProperties = module$exports$ninja$anim$animUtil$maybeReplaceMatrix(property$jscomp$0, []);
        } else {
          unevaluatedProperties = JSCompiler_StaticMethods_getAnimatedValuesAtTime_$self;
          a: {
            JSCompiler_inline_result = unevaluatedProperties.JSC$2546_tracks_;
            duration$jscomp$0 = property;
            iterations$jscomp$0 = time;
            $jscomp$inline_1029 = JSCompiler_inline_result.JSC$2527_tracks_.get(duration$jscomp$0);
            if (void 0 === $jscomp$inline_1029 || iterations$jscomp$0 <= JSCompiler_StaticMethods_getFirstKey($jscomp$inline_1029).time) {
              $jscomp$inline_1029 = null;
              break a;
            }
            const lastKey = JSCompiler_StaticMethods_getLastKey($jscomp$inline_1029);
            iterations$jscomp$0 > lastKey.time ? $jscomp$inline_1029 = lastKey : (JSCompiler_inline_result = JSCompiler_StaticMethods_getBoundingKeyframeTimes(JSCompiler_inline_result, iterations$jscomp$0, duration$jscomp$0), $jscomp$inline_1029 = JSCompiler_StaticMethods_JSC$2511_getKeyAtTime($jscomp$inline_1029, JSCompiler_inline_result.left));
          }
          unevaluatedProperties = $jscomp$inline_1029 && unevaluatedProperties.dummyElement_ ? JSCompiler_StaticMethods_matchUnits_(property, property$jscomp$0, $jscomp$inline_1029.value, unevaluatedProperties.dummyElement_) : property$jscomp$0;
        }
...
class module$exports$ninja$anim$AnimationEvaluator {
  constructor(element, tracks, adapter) {
    this.JSC$2546_element_ = element;
    this.JSC$2546_tracks_ = tracks;
...
;var module$exports$ninja$runtime$math$bezierSegment2d$BezierSegment2d = class {
  constructor(x1, y1, x2, y2) {
    this.JSC$2561_xBezier_ = new module$exports$ninja$runtime$math$baseBezierSegment$BaseBezierSegment(goog$vec$vec4d$createFromValues(x1, x2));
    this.JSC$2561_yBezier_ = new module$exports$ninja$runtime$math$baseBezierSegment$BaseBezierSegment(goog$vec$vec4d$createFromValues(y1, y2));
  }
};
...
function JSCompiler_StaticMethods_JSC$2589_initialize_(JSCompiler_StaticMethods_JSC$2589_initialize_$self) {
  JSCompiler_StaticMethods_JSC$2589_initialize_$self.container_ = document.createElement("P" === JSCompiler_StaticMethods_JSC$2589_initialize_$self.JSC$2574_element_.tagName || module$contents$ninja$runtime$texteffects$textEffectsTrack_inlineTextTags.has(JSCompiler_StaticMethods_JSC$2589_initialize_$self.JSC$2574_element_.tagName) ? "SPAN" : "DIV");
  JSCompiler_StaticMethods_createTokens_(JSCompiler_StaticMethods_JSC$2589_initialize_$self);
  JSCompiler_StaticMethods_shuffleTokens_(JSCompiler_StaticMethods_JSC$2589_initialize_$self);
  JSCompiler_StaticMethods_JSC$2589_initialize_$self.JSC$2574_element_.textContent = "";
  if (JSCompiler_StaticMethods_JSC$2589_initialize_$self.effects_.some(effect => "scroll" === effect.name && "vanishing-point" === effect.parameters.scrollType)) {
    const vanishingPointContainer = JSCompiler_StaticMethods_JSC$2589_initialize_$self.container_.cloneNode(!1);
    vanishingPointContainer.appendChild(JSCompiler_StaticMethods_JSC$2589_initialize_$self.container_);
    JSCompiler_StaticMethods_JSC$2589_initialize_$self.JSC$2574_element_.appendChild(vanishingPointContainer);
  } else {
    JSCompiler_StaticMethods_JSC$2589_initialize_$self.JSC$2574_element_.appendChild(JSCompiler_StaticMethods_JSC$2589_initialize_$self.container_);
  }
}
function JSCompiler_StaticMethods_createTokens_(JSCompiler_StaticMethods_createTokens_$self) {
  ...
  if (tokenTypes.has("text")) {
    ...
    for (const child of JSCompiler_StaticMethods_createTokens_$self.JSC$2574_element_.childNodes) {
...
function JSCompiler_StaticMethods_getCharactersAndTagsForLines_(JSCompiler_StaticMethods_getCharactersAndTagsForLines_$self) {
  var charactersAndTags = module$contents$ninja$runtime$texteffects$textEffectsTrack_flattenIntoCharactersAndTags(JSCompiler_StaticMethods_getCharactersAndTagsForLines_$self.JSC$2574_element_);
  ...
  JSCompiler_StaticMethods_getCharactersAndTagsForLines_$self.JSC$2574_element_.insertBefore(tempContainer, JSCompiler_StaticMethods_getCharactersAndTagsForLines_$self.JSC$2574_element_.childNodes[0]);
  ...
  JSCompiler_StaticMethods_getCharactersAndTagsForLines_$self.JSC$2574_element_.removeChild(tempContainer);
  return linesAndTags;
}
...
function JSCompiler_StaticMethods_getWordTokens_(JSCompiler_StaticMethods_getWordTokens_$self) {
  JSCompiler_StaticMethods_getWordTokens_$self = module$contents$ninja$runtime$texteffects$textEffectsTrack_flattenIntoCharactersAndTags(JSCompiler_StaticMethods_getWordTokens_$self.JSC$2574_element_);
...
function JSCompiler_StaticMethods_getCharacterTokens_(JSCompiler_StaticMethods_getCharacterTokens_$self, element) {
  ...
  if (element !== JSCompiler_StaticMethods_getCharacterTokens_$self.JSC$2574_element_) {
...
var module$exports$ninja$runtime$texteffects$textEffectsTrack$TextEffectsTrack = class {
  constructor(element, effects) {
    this.JSC$2574_element_ = element;
    ...
    JSCompiler_StaticMethods_JSC$2589_initialize_(this);
  }
};
...
function JSCompiler_StaticMethods_createAnimationEvaluator_(JSCompiler_StaticMethods_createAnimationEvaluator_$self, element, animIndex, animNameToRuleMap) {
      ...
      for (JSCompiler_inline_result = -1, value = module$exports$ninja$anim$animUtil$getKeyTimeMs("0%", trackType, styles), range = module$exports$ninja$anim$animUtil$getKeyTimeMs("100%", trackType, styles), value === range && (getBaseStyle = 0), value = 0; value < getBaseStyle; value++) {
        ...
        if (time !== JSCompiler_inline_result && (value === getBaseStyle - 1 || time !== range)) {
          ...
          for (let j = 0; j < time$jscomp$0.style.length; j++) {
            ...
            property = property.includes("transform-origin-x") || property.includes("transform-origin-y") || property.includes("transform-origin-z") ? "transform-origin" : property.includes("background-position-x") || property.includes("background-position-y") ? "background-position" : property.includes("mask-size-") ? module$exports$ninja$constants$checkCefMajorVersion() ? "mask-size" : "-webkit-mask-size" : property.includes("mask-position-") ? module$exports$ninja$constants$checkCefMajorVersion() ? 
            "mask-position" : "-webkit-mask-position" : property.includes("mask-repeat-") ? module$exports$ninja$constants$checkCefMajorVersion() ? "mask-repeat" : "-webkit-mask-repeat" : property;
  ...
  if (animNameToRuleMap && 2 > key.length) {
    ...
    if (animNameToRuleMap = animIndex.JSC$2527_tracks_.get("transform")) {
...
function JSCompiler_StaticMethods_JSC$2603_initialize_(JSCompiler_StaticMethods_JSC$2603_initialize_$self) {
  const page = JSCompiler_StaticMethods_JSC$2603_initialize_$self.doc_.querySelector("gwd-page");
  if (!page) {
    return null;
  }
  page.classList.add("gwd-play-animation");
  var styleNodes = JSCompiler_StaticMethods_JSC$2603_initialize_$self.doc_.getElementsByTagName("head")[0].querySelectorAll("style");
  const animNameToRuleMap = new Map();
  var docWindow = JSCompiler_StaticMethods_JSC$2603_initialize_$self.doc_.documentElement.ownerDocument.defaultView;
  ...
  for (const element of docWindow) {
    if (docWindow = JSCompiler_StaticMethods_createAnimationEvaluator_(JSCompiler_StaticMethods_JSC$2603_initialize_$self, element, 0, animNameToRuleMap), node = JSCompiler_StaticMethods_createAnimationEvaluator_(JSCompiler_StaticMethods_JSC$2603_initialize_$self, element, 1, animNameToRuleMap), scope = module$exports$ninja$runtime$texteffects$textEffectsTrack$TextEffectsTrack$createFromElement(element), (docWindow || node || scope) && JSCompiler_StaticMethods_JSC$2603_initialize_$self.elementToAnimEvaluatorsMap_.set(element, 
    {elementEvaluator:docWindow, maskEvaluator:node, textEffectsEvaluator:scope}), docWindow || node) {
      JSCompiler_StaticMethods_JSC$2603_initialize_$self.elementToAnimNameMap_.set(element, element.style.getPropertyValue("animation-name")), element.style.setProperty("animation-name", "none");
    }
  }
  return page;
}
function JSCompiler_StaticMethods_initializeForVideo(JSCompiler_StaticMethods_initializeForVideo$self, frameSequence) {
  JSCompiler_StaticMethods_initializeForVideo$self.JSC$2596_frameSequence_ = frameSequence;
  frameSequence = JSCompiler_StaticMethods_JSC$2603_initialize_(JSCompiler_StaticMethods_initializeForVideo$self);
  if (!frameSequence) {
  ...
  for (const elem of videoClipElements) {
    if (videoClipElements = module$contents$ninja$model$av$avClipParser_parseAvClip(elem)) {
      if (JSCompiler_StaticMethods_initializeForVideo$self.elementToAvClipsMap_.set(elem, videoClipElements), "video" === videoClipElements.clipType) {
        videoClipElements = new module$exports$ninja$capture$VideoClipController$VideoClipController(elem, videoClipElements, JSCompiler_StaticMethods_initializeForVideo$self.JSC$2596_frameSequence_), JSCompiler_StaticMethods_initializeForVideo$self.videoControllers_.push(videoClipElements);
...
function JSCompiler_StaticMethods_setTime_(JSCompiler_StaticMethods_setTime_$self, timeMs) {
  for (const element of JSCompiler_StaticMethods_setTime_$self.elementToAnimEvaluatorsMap_.keys()) {
    ...
    if (null != (elemValues = textEffectsEvaluator)) {
      ...
      maskValues = effect;
      var time = goog$math$clamp(timeMs, effect.startTimeMs, effect.startTimeMs + effect.durationMs), container = elemValues.container_.parentElement === elemValues.JSC$2574_element_ ? elemValues.container_ : elemValues.container_.parentElement;
      ...
      time = tokenType.JSC$2561_yBezier_.value(JSCompiler_StaticMethods_curveParameterAtValue(tokenType.JSC$2561_xBezier_, time)) * maskValues.durationMs + maskValues.startTimeMs;
      ...
      for (let i = 0; i < effect.length; i++) {
        ...
        var JSCompiler_temp;
        (JSCompiler_temp = -1 < (window.navigator.userAgent || "").indexOf("Edge")) || (JSCompiler_temp = (window.navigator.userAgent || "").match(/Chrome\/(\d+)\./), JSCompiler_temp = 120 > (JSCompiler_temp ? parseInt(JSCompiler_temp[1], 10) : -1));
        var maskImageProperty = JSCompiler_temp ? "-webkit-mask-image" : "mask-image";
        JSCompiler_temp = container ? effect[container[i]] : effect[i];
        if ("blur" === maskValues.name) {
          maskImageProperty = maskValues.parameters, JSCompiler_temp.style.opacity = String(goog$math$lerp(maskImageProperty.opacity, 1, delay)), JSCompiler_temp.style.filter = `blur(${goog$math$lerp(maskImageProperty.radius, 0, delay).toFixed(5)}px)`;
        } else if ("gradient" === maskValues.name) {
          var params = maskValues.parameters;
          JSCompiler_temp.style[maskImageProperty] = `linear-gradient(${params.angle}deg, black, ${100 * delay}%, rgba(0, 0, 0, ${params.opacity}))`;
          JSCompiler_temp.style.display = "inline-block";
          JSCompiler_temp.style["white-space"] = "pre-wrap";
        } else if (module$exports$ninja$runtime$texteffects$textEffectsConstants$TRANSLATION_EFFECTS.has(maskValues.name)) {
          maskImageProperty = maskValues.parameters, params = `translate${maskImageProperty.dimension}(${(1 - delay) * maskImageProperty.initialTranslation}px)`, "drop-in" === maskValues.name && (params = `perspective(${maskImageProperty.perspective}px) ${params}`, JSCompiler_StaticMethods_setContainerStylesFor3DTransformEffects_(elemValues)), JSCompiler_temp.style.display = "inline-block", JSCompiler_temp.style.whiteSpace = "pre-wrap", JSCompiler_temp.style.opacity = String(goog$math$lerp(maskImageProperty.opacity, 
          1, delay)), JSCompiler_temp.style.transform = params;
        } else if (module$exports$ninja$runtime$texteffects$textEffectsConstants$ROTATION_EFFECTS.has(maskValues.name)) {
          maskImageProperty = maskValues.parameters, JSCompiler_temp.style.transformOrigin = maskImageProperty.transformOrigin, JSCompiler_temp.style.display = "inline-block", JSCompiler_temp.style.whiteSpace = "pre-wrap", JSCompiler_temp.style.opacity = String(goog$math$lerp(maskImageProperty.opacity, 1, delay)), JSCompiler_temp.style.transform = `rotate${maskImageProperty.axis}(${goog$math$lerp(maskImageProperty.initialRotationDegrees, 0, delay)}deg)`, JSCompiler_StaticMethods_setContainerStylesFor3DTransformEffects_(elemValues);
        } else if ("typewriter" === maskValues.name) {
          maskImageProperty = maskValues.parameters, "linear" === maskImageProperty.easing ? JSCompiler_temp.style.opacity = String(goog$math$lerp(maskImageProperty.opacity, 1, delay)) : "step" === maskImageProperty.easing && (JSCompiler_temp.style.opacity = String(.999999 > delay ? maskImageProperty.opacity : 1));
        } else if ("zoom" === maskValues.name) {
          maskImageProperty = maskValues.parameters, params = delay * (2 * (maskImageProperty.scale - 100) + 100), params > maskImageProperty.scale && (params = 2 * maskImageProperty.scale - params), JSCompiler_temp.style.display = "inline-block", JSCompiler_temp.style.whiteSpace = "pre-wrap", JSCompiler_temp.style.opacity = String(goog$math$lerp(maskImageProperty.opacity, 1, delay)), JSCompiler_temp.style.transform = `scale(${params / 100})`;
        } else if ("slide" === maskValues.name) {
          maskImageProperty = maskValues.parameters;
          var initialTranslate = 0;
          params = "";
          "bottom" === maskImageProperty.direction ? (initialTranslate = elemValues.JSC$2574_element_.offsetHeight, params = "Y") : "top" === maskImageProperty.direction ? (initialTranslate = -elemValues.JSC$2574_element_.offsetHeight, params = "Y") : "left" === maskImageProperty.direction ? (initialTranslate = -elemValues.JSC$2574_element_.offsetWidth, params = "X") : "right" === maskImageProperty.direction && (initialTranslate = elemValues.JSC$2574_element_.offsetWidth, params = "X");
          initialTranslate = goog$math$lerp(initialTranslate, 0, delay);
          JSCompiler_temp.style.display = "inline-block";
          JSCompiler_temp.style.whiteSpace = "pre-wrap";
          JSCompiler_temp.style.opacity = String(goog$math$lerp(maskImageProperty.opacity, 1, delay));
          JSCompiler_temp.style.transform = `translate${params}(${initialTranslate}px)`;
          elemValues.container_.style.overflow = "hidden";
          elemValues.container_.style.display = "inline-block";
        } else {
          "scroll" === maskValues.name && (params = elemValues.JSC$2574_element_.clientHeight, JSCompiler_temp.style.display = "inline-block", JSCompiler_temp.style.transform = `translateY(${goog$math$lerp(params, -JSCompiler_temp.clientHeight, delay)}px)`, elemValues.container_.style.height = "100%", elemValues.container_.style.overflow = "hidden", elemValues.container_.style.display = "inline-block", "vanishing-point" === maskValues.parameters.scrollType && (delay = elemValues.container_.parentElement, 
          delay.style.height = "100%", delay.style.overflow = "hidden", delay.style.display = "inline-block", delay.style.perspective = `${elemValues.JSC$2574_element_.clientHeight}px`, elemValues.container_.style.transformOrigin = "bottom", elemValues.container_.style.transform = "rotateX(30deg) scale(1, 1.2)", elemValues.container_.style[maskImageProperty] = "linear-gradient(transparent 0%, black 45%)"));
        }
        if (i === effect.length - 1 || JSCompiler_temp.getBoundingClientRect().left >= effect[i + 1].getBoundingClientRect().left) {
          JSCompiler_temp.style.removeProperty("white-space"), "character" === maskValues.tokenType && JSCompiler_temp.closest("[character-word-container-element]").style.removeProperty("white-space");
        }
      }
    }
  }
...
function JSCompiler_StaticMethods_nextVideoFrame(JSCompiler_StaticMethods_nextVideoFrame$self) {
  if (JSCompiler_StaticMethods_nextVideoFrame$self.numUpdates_ >= JSCompiler_StaticMethods_nextVideoFrame$self.JSC$2596_frameSequence_.length()) {
    return Promise.resolve();
  }
  var timeMs = JSCompiler_StaticMethods_sequenceIndexToTimeMs(JSCompiler_StaticMethods_nextVideoFrame$self.JSC$2596_frameSequence_, JSCompiler_StaticMethods_nextVideoFrame$self.numUpdates_);
  ...
  for (const controller of JSCompiler_StaticMethods_nextVideoFrame$self.videoControllers_) {
    ...
    controller.isActive_ = !1, JSCompiler_inline_result = Promise.resolve()) : (JSCompiler_inline_result = JSCompiler_StaticMethods_sequenceIndexToTimeMs(controller.JSC$2503_frameSequence_, controller.currentSequenceIndex_), JSCompiler_inline_result = JSCompiler_StaticMethods_JSC$2417_seek(controller.backingVideo_, (controller.isHold_ ? controller.inTimeMs_ : JSCompiler_inline_result + controller.inTimeMs_ - controller.startTimeMs_) + .1)), name.call(element, JSCompiler_inline_result));
  }
...
var module$exports$ninja$capture$DomController$DomController = class {
  constructor() {
    ...
    this.JSC$2596_frameSequence_ = null;
...
async function JSCompiler_StaticMethods_captureSingleImage_(JSCompiler_StaticMethods_captureSingleImage_$self, controller, variantName, size) {
  ...
  JSCompiler_StaticMethods_JSC$2603_initialize_(controller);
...
function module$contents$goog$async$throwException_throwException() {
  var exception = Error("Storage mechanism: Storage unavailable");
...
class module$contents$goog$iter$es6_ShimGoogIterator extends goog$iter$Iterator {
  constructor(iter) {
    super();
    this.JSC$2666_iter_ = iter;
  }
  next() {
    return this.JSC$2666_iter_.next();
  }
  [Symbol.iterator]() {
    return new module$contents$goog$iter$es6_ShimEs6Iterator(this.JSC$2666_iter_);
  }
  toEs6() {
    return new module$contents$goog$iter$es6_ShimEs6Iterator(this.JSC$2666_iter_);
  }
...
class module$contents$goog$iter$es6_ShimEs6Iterator extends module$contents$goog$iter$es6_ShimIterableImpl {
  constructor(iter) {
    super(() => iter);
    this.JSC$2670_iter_ = iter;
  }
  next() {
    return this.JSC$2670_iter_.next();
  }
}
...
function goog$storage$mechanism$HTML5WebStorage(storage) {
  this.JSC$2678_storage_ = storage;
  this.cachedIsStorageAvailable_ = null;
}
...
goog$storage$mechanism$HTML5WebStorage.prototype.set = function(key, value) {
  JSCompiler_StaticMethods_throwIfStorageUnavailable_(this);
  try {
    this.JSC$2678_storage_.setItem(key, value);
  } catch (e) {
    if (0 == this.JSC$2678_storage_.length) {
...
goog$storage$mechanism$HTML5WebStorage.prototype.get = function(key) {
  JSCompiler_StaticMethods_throwIfStorageUnavailable_(this);
  key = this.JSC$2678_storage_.getItem(key);
...
goog$storage$mechanism$HTML5WebStorage.prototype.remove = function(key) {
  JSCompiler_StaticMethods_throwIfStorageUnavailable_(this);
  this.JSC$2678_storage_.removeItem(key);
};
goog$storage$mechanism$HTML5WebStorage.prototype.__iterator__ = function(opt_keys) {
  JSCompiler_StaticMethods_throwIfStorageUnavailable_(this);
  var i = 0, storage = this.JSC$2678_storage_, newIter = new goog$iter$Iterator();
...
goog$storage$mechanism$HTML5WebStorage.prototype.key = function(index) {
  JSCompiler_StaticMethods_throwIfStorageUnavailable_(this);
  return this.JSC$2678_storage_.key(index);
};
function JSCompiler_StaticMethods_throwIfStorageUnavailable_(JSCompiler_StaticMethods_throwIfStorageUnavailable_$self) {
  if (null == JSCompiler_StaticMethods_throwIfStorageUnavailable_$self.JSC$2678_storage_) {
    throw Error("Storage mechanism: Storage unavailable");
  }
  let $jscomp$nullish$tmp9;
  (null != ($jscomp$nullish$tmp9 = JSCompiler_StaticMethods_throwIfStorageUnavailable_$self.cachedIsStorageAvailable_) ? $jscomp$nullish$tmp9 : JSCompiler_StaticMethods_throwIfStorageUnavailable_$self.cachedIsStorageAvailable_ = goog$storage$mechanism$HTML5WebStorage$isAvailable_(JSCompiler_StaticMethods_throwIfStorageUnavailable_$self.JSC$2678_storage_)) || module$contents$goog$async$throwException_throwException();
}
function goog$storage$mechanism$HTML5WebStorage$isAvailable_(storage) {
  if (!storage) {
    return !1;
  }
  try {
    return storage.setItem("__sak", "1"), storage.removeItem("__sak"), !0;
  } catch (e) {
    return e instanceof DOMException && ("QuotaExceededError" === e.name || 22 === e.code || 1014 === e.code || "NS_ERROR_DOM_QUOTA_REACHED" === e.name) && storage && 0 !== storage.length;
  }
}
...
function JSCompiler_StaticMethods_isLocalStorageAvailable_(JSCompiler_StaticMethods_isLocalStorageAvailable_$self) {
  var JSCompiler_temp;
  if (JSCompiler_temp = null != JSCompiler_StaticMethods_isLocalStorageAvailable_$self.JSC$2685_storage_) {
    JSCompiler_StaticMethods_isLocalStorageAvailable_$self = JSCompiler_StaticMethods_isLocalStorageAvailable_$self.JSC$2685_storage_, JSCompiler_temp = JSCompiler_StaticMethods_isLocalStorageAvailable_$self.cachedIsStorageAvailable_ = goog$storage$mechanism$HTML5WebStorage$isAvailable_(JSCompiler_StaticMethods_isLocalStorageAvailable_$self.JSC$2678_storage_);
  }
...
function JSCompiler_StaticMethods_saveHistory_(JSCompiler_StaticMethods_saveHistory_$self) {
  if (JSCompiler_StaticMethods_isLocalStorageAvailable_(JSCompiler_StaticMethods_saveHistory_$self)) {
    try {
      JSCompiler_StaticMethods_saveHistory_$self.JSC$2685_storage_.set("__webmonitoring_RateThrottler_history_hourlyRate", JSON.stringify(JSCompiler_StaticMethods_saveHistory_$self.history_));
    } catch (e) {
    }
  }
}
const module$contents$webmonitoring$RateThrottler_RateThrottler = class {
  constructor(count, useLocalStorage) {
    ...
    this.JSC$2685_storage_ = null;
    useLocalStorage && (this.JSC$2685_storage_ = new goog$storage$mechanism$HTML5LocalStorage());
    if (JSCompiler_StaticMethods_isLocalStorageAvailable_(this) && (count = this.JSC$2685_storage_.get("__webmonitoring_RateThrottler_history_hourlyRate"), null != count)) {
      try {
    ...
    for (; this.history_.length > this.JSC$2685_count_;) {
...
function goog$events$BrowserEvent(opt_e, opt_currentTarget) {
  ...
  this.relatedTarget = this.JSC$2407_currentTarget = this.target = null;
  ...
  if (opt_e) {
    ...
    this.JSC$2407_currentTarget = opt_currentTarget;
    ...
    this.event_ = opt_e;
    opt_e.defaultPrevented && goog$events$BrowserEvent.superClass_.JSC$2409_preventDefault.call(this);
  }
}
goog$inherits(goog$events$BrowserEvent, goog$events$Event);
var goog$events$BrowserEvent$IE_POINTER_TYPE_MAP = {2:"touch", 3:"pen", 4:"mouse"};
goog$events$BrowserEvent.prototype.JSC$2409_preventDefault = function() {
  goog$events$BrowserEvent.superClass_.JSC$2409_preventDefault.call(this);
  var be = this.event_;
...
function JSCompiler_StaticMethods_JSC$2797_dispatchEvent(JSCompiler_StaticMethods_JSC$2797_dispatchEvent$self, e) {
  var ancestorsTree, ancestor = JSCompiler_StaticMethods_JSC$2797_dispatchEvent$self.parentEventTarget_;
  if (ancestor) {
    for (ancestorsTree = []; ancestor; ancestor = ancestor.parentEventTarget_) {
      ancestorsTree.push(ancestor);
    }
  }
  JSCompiler_StaticMethods_JSC$2797_dispatchEvent$self = JSCompiler_StaticMethods_JSC$2797_dispatchEvent$self.actualEventTarget_;
  ancestor = e.type || e;
  if ("string" === typeof e) {
    e = new goog$events$Event(e, JSCompiler_StaticMethods_JSC$2797_dispatchEvent$self);
  } else if (e instanceof goog$events$Event) {
    e.target = e.target || JSCompiler_StaticMethods_JSC$2797_dispatchEvent$self;
  } else {
    var oldEvent = e;
    e = new goog$events$Event(ancestor, JSCompiler_StaticMethods_JSC$2797_dispatchEvent$self);
    module$contents$goog$object_extend(e, oldEvent);
  }
  oldEvent = !0;
  if (ancestorsTree) {
    for (var i = ancestorsTree.length - 1; 0 <= i; i--) {
      var currentTarget = e.JSC$2407_currentTarget = ancestorsTree[i];
      oldEvent = JSCompiler_StaticMethods_fireListeners(currentTarget, ancestor, !0, e) && oldEvent;
    }
  }
  currentTarget = e.JSC$2407_currentTarget = JSCompiler_StaticMethods_JSC$2797_dispatchEvent$self;
  oldEvent = JSCompiler_StaticMethods_fireListeners(currentTarget, ancestor, !0, e) && oldEvent;
  oldEvent = JSCompiler_StaticMethods_fireListeners(currentTarget, ancestor, !1, e) && oldEvent;
  if (ancestorsTree) {
    for (i = 0; i < ancestorsTree.length; i++) {
      currentTarget = e.JSC$2407_currentTarget = ancestorsTree[i], oldEvent = JSCompiler_StaticMethods_fireListeners(currentTarget, ancestor, !1, e) && oldEvent;
    }
  }
}
...
function JSCompiler_StaticMethods_getOptions(JSCompiler_StaticMethods_getOptions$self) {
  var JSCompiler_temp;
  (JSCompiler_temp = JSCompiler_StaticMethods_getOptions$self.cachedOptions_) || (JSCompiler_temp = JSCompiler_StaticMethods_getOptions$self.cachedOptions_ = {});
  return JSCompiler_temp;
}
...
function JSCompiler_StaticMethods_JSC$2749_send(JSCompiler_StaticMethods_JSC$2749_send$self, url, opt_content, opt_headers) {
  if (JSCompiler_StaticMethods_JSC$2749_send$self.xhr_) {
    throw Error("[goog.net.XhrIo] Object is active with another request=" + JSCompiler_StaticMethods_JSC$2749_send$self.lastUri_ + "; newUri=" + url);
  }
  JSCompiler_StaticMethods_JSC$2749_send$self.lastUri_ = url;
  JSCompiler_StaticMethods_JSC$2749_send$self.errorDispatched_ = !1;
  JSCompiler_StaticMethods_JSC$2749_send$self.active_ = !0;
  JSCompiler_StaticMethods_JSC$2749_send$self.xhr_ = new XMLHttpRequest();
  JSCompiler_StaticMethods_JSC$2749_send$self.xhrOptions_ = JSCompiler_StaticMethods_JSC$2749_send$self.xmlHttpFactory_ ? JSCompiler_StaticMethods_getOptions(JSCompiler_StaticMethods_JSC$2749_send$self.xmlHttpFactory_) : JSCompiler_StaticMethods_getOptions(goog$net$XmlHttp$factory_);
  JSCompiler_StaticMethods_JSC$2749_send$self.xhr_.onreadystatechange = goog$bind(JSCompiler_StaticMethods_JSC$2749_send$self.onReadyStateChange_, JSCompiler_StaticMethods_JSC$2749_send$self);
  try {
    JSCompiler_StaticMethods_JSC$2749_send$self.inOpen_ = !0, JSCompiler_StaticMethods_JSC$2749_send$self.xhr_.open("POST", String(url), !0), JSCompiler_StaticMethods_JSC$2749_send$self.inOpen_ = !1;
  } catch (err) {
    JSCompiler_StaticMethods_error_(JSCompiler_StaticMethods_JSC$2749_send$self);
    return;
  }
  url = opt_content || "";
  opt_content = new Map(JSCompiler_StaticMethods_JSC$2749_send$self.headers);
  if (opt_headers) {
  ...
  for (const [key, value] of opt_content) {
    JSCompiler_StaticMethods_JSC$2749_send$self.xhr_.setRequestHeader(key, value);
  }
  JSCompiler_StaticMethods_JSC$2749_send$self.responseType_ && (JSCompiler_StaticMethods_JSC$2749_send$self.xhr_.responseType = JSCompiler_StaticMethods_JSC$2749_send$self.responseType_);
  "withCredentials" in JSCompiler_StaticMethods_JSC$2749_send$self.xhr_ && JSCompiler_StaticMethods_JSC$2749_send$self.xhr_.withCredentials !== JSCompiler_StaticMethods_JSC$2749_send$self.withCredentials_ && (JSCompiler_StaticMethods_JSC$2749_send$self.xhr_.withCredentials = JSCompiler_StaticMethods_JSC$2749_send$self.withCredentials_);
  try {
    JSCompiler_StaticMethods_cleanUpTimeoutTimer_(JSCompiler_StaticMethods_JSC$2749_send$self), 0 < JSCompiler_StaticMethods_JSC$2749_send$self.timeoutInterval_ && (JSCompiler_StaticMethods_JSC$2749_send$self.timeoutId_ = goog$Timer$callOnce(JSCompiler_StaticMethods_JSC$2749_send$self.timeout_, JSCompiler_StaticMethods_JSC$2749_send$self.timeoutInterval_, JSCompiler_StaticMethods_JSC$2749_send$self)), JSCompiler_StaticMethods_JSC$2749_send$self.inSend_ = !0, JSCompiler_StaticMethods_JSC$2749_send$self.xhr_.send(url), 
    JSCompiler_StaticMethods_JSC$2749_send$self.inSend_ = !1;
  } catch (err) {
    JSCompiler_StaticMethods_error_(JSCompiler_StaticMethods_JSC$2749_send$self);
  }
}
goog$net$XhrIo.prototype.timeout_ = function() {
  "undefined" != typeof goog && this.xhr_ && (JSCompiler_StaticMethods_JSC$2797_dispatchEvent(this, "timeout"), this.abort(8));
};
...
function JSCompiler_StaticMethods_dispatchErrors_(JSCompiler_StaticMethods_dispatchErrors_$self) {
  JSCompiler_StaticMethods_dispatchErrors_$self.errorDispatched_ || (JSCompiler_StaticMethods_dispatchErrors_$self.errorDispatched_ = !0, JSCompiler_StaticMethods_JSC$2797_dispatchEvent(JSCompiler_StaticMethods_dispatchErrors_$self, "complete"), JSCompiler_StaticMethods_JSC$2797_dispatchEvent(JSCompiler_StaticMethods_dispatchErrors_$self, "error"));
}
goog$net$XhrIo.prototype.abort = function() {
  this.xhr_ && this.active_ && (this.active_ = !1, this.inAbort_ = !0, this.xhr_.abort(), this.inAbort_ = !1, JSCompiler_StaticMethods_JSC$2797_dispatchEvent(this, "complete"), JSCompiler_StaticMethods_JSC$2797_dispatchEvent(this, "abort"), JSCompiler_StaticMethods_cleanUpXhr_(this));
};
...
function JSCompiler_StaticMethods_onReadyStateChangeHelper_(JSCompiler_StaticMethods_onReadyStateChangeHelper_$self) {
  if (JSCompiler_StaticMethods_onReadyStateChangeHelper_$self.active_ && "undefined" != typeof goog && (!JSCompiler_StaticMethods_onReadyStateChangeHelper_$self.xhrOptions_[1] || 4 != (JSCompiler_StaticMethods_onReadyStateChangeHelper_$self.xhr_ ? JSCompiler_StaticMethods_onReadyStateChangeHelper_$self.xhr_.readyState : 0) || 2 != JSCompiler_StaticMethods_getStatus(JSCompiler_StaticMethods_onReadyStateChangeHelper_$self))) {
    if (JSCompiler_StaticMethods_onReadyStateChangeHelper_$self.inSend_ && 4 == (JSCompiler_StaticMethods_onReadyStateChangeHelper_$self.xhr_ ? JSCompiler_StaticMethods_onReadyStateChangeHelper_$self.xhr_.readyState : 0)) {
      ...
      if (JSCompiler_StaticMethods_JSC$2797_dispatchEvent(JSCompiler_StaticMethods_onReadyStateChangeHelper_$self, "readystatechange"), 4 == (JSCompiler_StaticMethods_onReadyStateChangeHelper_$self.xhr_ ? JSCompiler_StaticMethods_onReadyStateChangeHelper_$self.xhr_.readyState : 0)) {
...
function JSCompiler_StaticMethods_cleanUpXhr_(JSCompiler_StaticMethods_cleanUpXhr_$self, opt_fromDispose) {
  if (JSCompiler_StaticMethods_cleanUpXhr_$self.xhr_) {
    ...
    opt_fromDispose || JSCompiler_StaticMethods_JSC$2797_dispatchEvent(JSCompiler_StaticMethods_cleanUpXhr_$self, "ready");
    try {
...
;function goog$Uri(opt_uri) {
  ...
  this.JSC$2754_ignoreCase_ = !1;
  var m;
  opt_uri instanceof goog$Uri ? (this.JSC$2754_ignoreCase_ = opt_uri.JSC$2754_ignoreCase_, JSCompiler_StaticMethods_setScheme(this, opt_uri.scheme_), this.userInfo_ = opt_uri.userInfo_, this.domain_ = opt_uri.domain_, JSCompiler_StaticMethods_setPort(this, opt_uri.port_), this.path_ = opt_uri.getPath(), JSCompiler_StaticMethods_setQueryData(this, opt_uri.queryData_.clone()), this.fragment_ = opt_uri.fragment_) : opt_uri && (m = String(opt_uri).match(goog$uri$utils$splitRe_)) ? (this.JSC$2754_ignoreCase_ = 
  !1, JSCompiler_StaticMethods_setScheme(this, m[1] || "", !0), this.userInfo_ = goog$Uri$decodeOrEmpty_(m[2] || ""), this.domain_ = goog$Uri$decodeOrEmpty_(m[3] || "", !0), JSCompiler_StaticMethods_setPort(this, m[4]), this.path_ = goog$Uri$decodeOrEmpty_(m[5] || "", !0), JSCompiler_StaticMethods_setQueryData(this, m[6] || "", !0), this.fragment_ = goog$Uri$decodeOrEmpty_(m[7] || "")) : (this.JSC$2754_ignoreCase_ = !1, this.queryData_ = new goog$Uri$QueryData(null, this.JSC$2754_ignoreCase_));
}
...
goog$Uri.prototype.resolve = function(relativeUri) {
  var absoluteUri = this.clone(), overridden = !!relativeUri.scheme_;
  overridden ? JSCompiler_StaticMethods_setScheme(absoluteUri, relativeUri.scheme_) : overridden = !!relativeUri.userInfo_;
  overridden ? absoluteUri.userInfo_ = relativeUri.userInfo_ : overridden = !!relativeUri.domain_;
  overridden ? absoluteUri.domain_ = relativeUri.domain_ : overridden = null != relativeUri.port_;
  ...
  if (overridden) {
    ...
    if (overridden = !!relativeUri.path_) {
      ...
      lastSlashIndex = path;
      if (".." == lastSlashIndex || "." == lastSlashIndex) {
        path = "";
      } else {
        if (-1 != lastSlashIndex.indexOf("./") || -1 != lastSlashIndex.indexOf("/.")) {
          path = 0 == lastSlashIndex.lastIndexOf("/", 0);
          lastSlashIndex = lastSlashIndex.split("/");
          for (var out = [], pos = 0; pos < lastSlashIndex.length;) {
            var segment = lastSlashIndex[pos++];
            "." == segment ? path && pos == lastSlashIndex.length && out.push("") : ".." == segment ? ((1 < out.length || 1 == out.length && "" != out[0]) && out.pop(), path && pos == lastSlashIndex.length && out.push("")) : (out.push(segment), path = !0);
          }
          path = out.join("/");
        } else {
          path = lastSlashIndex;
  ...
  overridden ? absoluteUri.path_ = path : overridden = "" !== relativeUri.queryData_.toString();
  overridden ? JSCompiler_StaticMethods_setQueryData(absoluteUri, relativeUri.queryData_.clone()) : overridden = !!relativeUri.fragment_;
  overridden && (absoluteUri.fragment_ = relativeUri.fragment_);
  return absoluteUri;
};
...
function JSCompiler_StaticMethods_setQueryData(JSCompiler_StaticMethods_setQueryData$self, queryData, opt_decode) {
  queryData instanceof goog$Uri$QueryData ? (JSCompiler_StaticMethods_setQueryData$self.queryData_ = queryData, JSCompiler_StaticMethods_JSC$2759_setIgnoreCase(JSCompiler_StaticMethods_setQueryData$self.queryData_, JSCompiler_StaticMethods_setQueryData$self.JSC$2754_ignoreCase_)) : (opt_decode || (queryData = goog$Uri$encodeSpecialChars_(queryData, goog$Uri$reDisallowedInQuery_)), JSCompiler_StaticMethods_setQueryData$self.queryData_ = new goog$Uri$QueryData(queryData, JSCompiler_StaticMethods_setQueryData$self.JSC$2754_ignoreCase_));
}
...
goog$Uri$QueryData.prototype.add = function(key, value) {
  ...
  values.push(value);
  this.JSC$2755_count_ += 1;
  return this;
};
goog$Uri$QueryData.prototype.remove = function(key) {
  JSCompiler_StaticMethods_ensureKeyMapInitialized_(this);
  key = JSCompiler_StaticMethods_getKeyName_(this, key);
  return this.keyMap_.has(key) ? (this.encodedQuery_ = null, this.JSC$2755_count_ -= this.keyMap_.get(key).length, this.keyMap_.delete(key)) : !1;
};
...
goog$Uri$QueryData.prototype.set = function(key, value) {
  ...
  this.encodedQuery_ = null;
  key = JSCompiler_StaticMethods_getKeyName_(this, key);
  JSCompiler_StaticMethods_containsKey(this, key) && (this.JSC$2755_count_ -= this.keyMap_.get(key).length);
...
goog$Uri$QueryData.prototype.clone = function() {
  ...
  this.keyMap_ && (rv.keyMap_ = new Map(this.keyMap_), rv.JSC$2755_count_ = this.JSC$2755_count_);
  return rv;
};
function JSCompiler_StaticMethods_getKeyName_(JSCompiler_StaticMethods_getKeyName_$self, arg) {
  arg = String(arg);
  JSCompiler_StaticMethods_getKeyName_$self.JSC$2755_ignoreCase_ && (arg = arg.toLowerCase());
  return arg;
}
function JSCompiler_StaticMethods_JSC$2759_setIgnoreCase(JSCompiler_StaticMethods_JSC$2759_setIgnoreCase$self, ignoreCase) {
  ignoreCase && !JSCompiler_StaticMethods_JSC$2759_setIgnoreCase$self.JSC$2755_ignoreCase_ && (JSCompiler_StaticMethods_ensureKeyMapInitialized_(JSCompiler_StaticMethods_JSC$2759_setIgnoreCase$self), JSCompiler_StaticMethods_JSC$2759_setIgnoreCase$self.encodedQuery_ = null, JSCompiler_StaticMethods_JSC$2759_setIgnoreCase$self.keyMap_.forEach(function(value, key) {
    ...
    if (key != lowerCase && (this.remove(key), this.remove(lowerCase), 0 < value.length)) {
      ...
      this.JSC$2755_count_ += value.length;
    }
  }, JSCompiler_StaticMethods_JSC$2759_setIgnoreCase$self));
  JSCompiler_StaticMethods_JSC$2759_setIgnoreCase$self.JSC$2755_ignoreCase_ = ignoreCase;
}
...
function JSCompiler_StaticMethods_setCrashCollectionUrl() {
  var JSCompiler_StaticMethods_enableCrashCollector$self = (new webmonitoring$Monitoring("Google Web Designer".replace(/ /g, "_"))).setVersion("16.1.0.0530".concat(".captureapp")).createJsErrorsReporter();
...
function JSCompiler_StaticMethods_constructErrorParams_(JSCompiler_StaticMethods_constructErrorParams_$self, uri, errorMessage, customFields, srcUrl, line, column) {
  ...
  params.set("os", module$contents$goog$labs$userAgent$platform_isChromeOS() ? "Chrome OS" : (module$contents$goog$labs$userAgent$platform_useUserAgentDataPlatform() ? "Linux" === JSCompiler_inline_result$jscomp$27.platform : module$contents$goog$labs$userAgent$util_matchUserAgent("Linux")) ? "Linux" : module$contents$goog$labs$userAgent$platform_isWindows() ? "Windows" : module$contents$goog$labs$userAgent$platform_isAndroid() ? "Android" : module$contents$goog$labs$userAgent$platform_isIphone() ? 
...
function JSCompiler_StaticMethods_upload_(JSCompiler_StaticMethods_upload_$self, uploadUrl, params, content) {
  ...
  JSCompiler_StaticMethods_JSC$2749_send(x, params, content, uploadUrl);
}
        ...
        if (JSCompiler_temp = (100 * Math.random()).toFixed(6) >= this.globalSampling_ * specialSampling / 100 ? !1 : !0) {
          ...
          if (null === this.rateThrottler_) {
            ...
            a: {
              ...
              if (JSCompiler_temp.history_.length == JSCompiler_temp.JSC$2685_count_) {
...
(function() {
  ...
  JSCompiler_StaticMethods_loadCaptureConfiguration_(urlParams).then(captureSpec => {
    var $jscomp$inline_901;
    let $jscomp$inline_902, $jscomp$inline_903, $jscomp$inline_904;
    if (!captureSpec.videoSpec && !captureSpec.imageSpec || 0 === (null == ($jscomp$inline_901 = captureSpec.videoSpec) ? void 0 : $jscomp$inline_901.variants.length) || 0 === (null == ($jscomp$inline_902 = captureSpec.videoSpec) ? void 0 : $jscomp$inline_902.sizesToCapture.length) || 0 === (null == ($jscomp$inline_903 = captureSpec.imageSpec) ? void 0 : $jscomp$inline_903.variantsToCapture.length) || 0 === (null == ($jscomp$inline_904 = captureSpec.imageSpec) ? void 0 : $jscomp$inline_904.sizesToCapture.length)) {
      throw new module$exports$ninja$capture$AppError$AppError(1, "The capture configuration is empty.");
    }
    $jscomp$inline_901 = new module$exports$ninja$capture$CaptureManager$CaptureManager(shell, captureSpec, instanceIndex);
    return captureSpec.videoSpec ? JSCompiler_StaticMethods_captureAllVideosOrGifs_($jscomp$inline_901) : JSCompiler_StaticMethods_captureAllImages_($jscomp$inline_901);
  }).catch(error => {
